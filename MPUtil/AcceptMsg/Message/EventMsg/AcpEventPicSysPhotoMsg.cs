...
namespace MPUtil.AcceptMsg.Message.EventMsg
{
    ...
    /// 弹出系统拍照发图的事件推送
    /// </summary>
    public class AcpEventPicSysPhotoMsg : AcpEventMsg
    {
        /// <summary>
        /// 事件KEY值，由开发者在创建菜单时设定
        /// </summary>
        ...
        public new AcpEventPicSysPhotoMsg Convert(string xmlmsg)
        {
            ...
            this.Event = Enum_WXAcpEventMsg_EventType.弹出系统拍照发图的事件推送;
