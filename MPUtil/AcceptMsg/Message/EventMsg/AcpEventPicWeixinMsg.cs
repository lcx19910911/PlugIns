...
namespace MPUtil.AcceptMsg.Message.EventMsg
{
    ...
    /// 弹出微信相册发图器的事件推送
    /// </summary>
    public class AcpEventPicWeixinMsg : AcpEventMsg
    {
        /// <summary>
        /// 事件KEY值，由开发者在创建菜单时设定
        /// </summary>
        ...
        public new AcpEventPicWeixinMsg Convert(string xmlmsg)
        {
            ...
            this.Event = Enum_WXAcpEventMsg_EventType.弹出微信相册发图器的事件推送;
